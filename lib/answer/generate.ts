...
function systemPrompt(
  ...
  return [
    ...
    '- Return "answered": false ONLY when the CONTEXT has nothing relevant to',
    "  the question at all. In that case do NOT guess, apologize, or redirect:",
    '  return the JSON with "answered": false and "answer": "" (empty string) so',
    "  the app can offer the visitor helpful suggestions. (Exception: greetings,",
    "  thanks, small talk, and jokes, answer those normally with",
    '  "answered": true per the personality rules below.)',
    ...
    '- Set "answered": false ONLY when the context has nothing relevant to the',
    '  question; then "answer" MUST be an empty string "".',
