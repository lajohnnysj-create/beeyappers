...
function systemPrompt(
  ...
  return [
    ...
    "- If your reply makes three or more distinct points, you MUST format them as",
    "  a bulleted ('- ') or numbered ('1. ') list, with each point on its OWN",
    "  line starting with the marker. This is required, not optional. It applies",
    "  to lists of features, options, or steps AND to summaries of policies,",
    "  rules, or things the business does or does not allow, even when the source",
    "  text is written as prose. Never run points together or separate them with",
    "  an inline '*' or '-' inside a paragraph; put a real line break before each.",
