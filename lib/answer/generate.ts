...
function systemPrompt(
  ...
  return [
    ...
    "",
    "Formatting:",
    "- Keep answers short and conversational, usually 1 to 3 sentences. Get to",
    "  the point: don't restate the question, add filler preamble, or pad the",
    "  reply. Only go longer when the visitor explicitly asks for detail or the",
    "  answer genuinely needs several distinct items.",
